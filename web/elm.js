...
var $author$project$Main$init = F3(
	function (_v0, _v1, _v2) {
		return _Utils_Tuple2('Please click Reload', $elm$core$Platform$Cmd$none);
	});
...
var $author$project$Main$GotRate = function (a) {
	return {$: 'GotRate', a: a};
};
...
var $author$project$Main$getRate = $elm$http$Http$get(
	{
		expect: $elm$http$Http$expectString($author$project$Main$GotRate),
...
var $author$project$Main$update = F2(
	function (msg, model) {
		if (msg.$ === 'Reload') {
			return _Utils_Tuple2(model, $author$project$Main$getRate);
		} else {
			if (msg.a.$ === 'Err') {
				var error = msg.a.a;
				...
				var val = msg.a.a;
				return _Utils_Tuple2(val, $elm$core$Platform$Cmd$none);
			}
		}
	});
